...
- "EPACES FOR MANUAL BILLING" → "EPACES"
"""
import sqlite3
import shutil
...
def backup_database():
    ...
    backup_path = Path(DB_PATH).with_suffix('.db.backup2')
...
def preview_changes():
    ...
    cur.execute("""
        ...
        FROM patients 
        WHERE primary_insurance = 'EPACES FOR MANUAL BILLING'
    ...
    cur.execute("""
        ...
        FROM patients 
        WHERE secondary_insurance = 'EPACES FOR MANUAL BILLING'
        ORDER BY last_name, first_name
    """)
...
def verify_updates():
    ...
    cur.execute("""
        ...
        WHERE primary_insurance = 'EPACES FOR MANUAL BILLING'
           OR secondary_insurance = 'EPACES FOR MANUAL BILLING'
    """)
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("INSURANCE NAME UPDATE UTILITY - EPACES FOR MANUAL BILLING")
    print("="*70)
